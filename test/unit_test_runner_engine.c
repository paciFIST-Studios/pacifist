...
int main(void) {
    ...
    ADD_TEST(fn_pf_allocator_free_list_calculate_padding__is_defined);
    ADD_TEST(fn_pf_allocator_free_list_calculate_padding__returns_correct_error_code__for_null_ptr_arg);
    ADD_TEST(fn_pf_allocator_free_list_calculate_padding__sets_correct_error_message__for_null_ptr_arg);
    ADD_TEST(fn_pf_allocator_free_list_calculate_padding__returns_correct_error_code__for_ptr_misaligned);
    ADD_TEST(fn_pf_allocator_free_list_calculate_padding__sets_correct_error_message__for_ptr_misaligned);
    ADD_TEST(fn_pf_allocator_free_list_calculate_padding__returns_correct_error_code__for_not_power_of_two_alignment);
    ADD_TEST(fn_pf_allocator_free_list_calculate_padding__sets_correct_error_message__for_not_power_of_two_alignment);
    ADD_TEST(fn_pf_allocator_free_list_calculate_padding__returns_zero__if_header_is_naturally_aligned_to_boundary);
    ADD_TEST(fn_pf_allocator_free_list_calculate_padding__returns_padding_number__when_used_correctly);
    ...
    ADD_TEST(fn_pf_os_path_is_directory_cstr_linux__returns_correct_error_code__for_null_path_param);
    ADD_TEST(fn_pf_os_path_is_directory_cstr_linux__sets_correct_error_message__for_null_path_param);
    ADD_TEST(fn_pf_os_path_is_directory_cstr_linux__returns_correct_error_code__for_zero_length_param);
    ADD_TEST(fn_pf_os_path_is_directory_cstr_linux__sets_correct_error_message__for_zero_length_param);
    ADD_TEST(fn_pf_os_path_is_directory_cstr_linux__returns_false__for_file);
    ADD_TEST(fn_pf_os_path_is_directory_cstr_linux__returns_true__for_directory);
    ADD_TEST(fn_pf_os_path_is_directory_cstr_linux__returns_false__for_invalid_path);

    // pf_os_path_is_directory_pstr_linux
    ADD_TEST(fn_pf_os_path_is_directory_pstr_linux__is_defined);
    ADD_TEST(fn_pf_os_path_is_directory_pstr_linux__returns_false__for_file);
    ADD_TEST(fn_pf_os_path_is_directory_pstr_linux__returns_true__for_directory);
    ADD_TEST(fn_pf_os_path_is_directory_pstr_linux__returns_false__for_invalid_path);

    // pf_os_file_size_cstr_linux
    ADD_TEST(fn_pf_os_file_size_cstr_linux__is_defined);
    ADD_TEST(fn_pf_os_file_size_cstr_linux__returns_correct_error_code__for_null_path_param);
    ADD_TEST(fn_pf_os_file_size_cstr_linux__sets_correct_error_message__for_null_path_param);
    ADD_TEST(fn_pf_os_file_size_cstr_linux__returns_correct_error_code__for_zero_length_param);
    ADD_TEST(fn_pf_os_file_size_cstr_linux__sets_correct_error_message__for_zero_length_param);
    ADD_TEST(fn_pf_os_file_size_cstr_linux__returns_file_size__for_file); 
    ADD_TEST(fn_pf_os_file_size_cstr_linux__returns_error_size__for_directory);
    ADD_TEST(fn_pf_os_file_size_cstr_linux__sets_correct_error_message__for_directory);
    ADD_TEST(fn_pf_os_file_size_cstr_linux__returns_error_size__for_invalid_path);

    // pf_os_file_size_pstr_linux
    ADD_TEST(fn_pf_os_file_size_pstr_linux__is_defined);
...
//    ADD_TEST(fn_pf_load_xml__sets_correct_error_message__if_supplied_file_cannot_be_opened);
    ...
    // constants
    ADD_TEST(constant_PFSLI_MAX_STRINGS__is_expected_value);
    ...
    ADD_TEST(struct_PFStringLifetimeInternmentSingleton_t__has_expected_members);

    // fn pf_string_internment_initialize
    ADD_TEST(fn_pf_string_lifetime_internment_create_with_memory__is_defined);
    ADD_TEST(fn_pf_string_lifetime_internment_create_with_memory__returns_null__for_null_string_internment_param);
    ADD_TEST(fn_pf_string_lifetime_internment_create_with_memory__sets_correct_error_message__for_null_string_internment_param);
    ADD_TEST(pf_string_lifetime_internment_create_with_memory__returns_null__for_null_memory_base_param);
    ADD_TEST(pf_string_lifetime_internment_create_with_memory__sets_correct_error_message__for_null_memory_base_param);
    ADD_TEST(pf_string_lifetime_internment_create_with_memory__returns_correct_error_code__for_invalid_memory_size);
    ADD_TEST(pf_string_lifetime_internment_create_with_memory__sets_correct_error_message__for_invalid_memory_size);
    ADD_TEST(pf_string_lifetime_internment_create_with_memory__correctly_initializes_string_internment__for_expected_arguments);

    // fn pf_string_internment_emplace_cstring
    ADD_TEST(fn_pf_string_lifetime_internment_emplace_cstring__is_defined);
    // first param
    ADD_TEST(fn_pf_string_lifetime_internment_emplace_cstr__returns_correct_error_code__for_null_ptr_to_PFStringLifetimeInternmentSingleton_t);
    ADD_TEST(fn_pf_string_lifetime_internment_emplace_cstr__sets_correct_error_message__for_null_ptr_to_PFStirngLifetimeInternmentSingleton_t);
    ADD_TEST(fn_pf_string_lifetime_internment_emplace_cstr__returns_correct_error_code__for_null_ptr_to_memory_base_in_PFStringLifetimeInternmentSingleton_t);
    ADD_TEST(fn_pf_string_lifetime_internment_emplace_cstr__sets_correct_error_message__for_null_ptr_to_memory_base_in_PFStringLifetimeInternmentSingleton_t);
    ADD_TEST(fn_pf_string_lifeitme_internment_emplace_cstr__returns_correct_error_code__for_invalid_owned_memory_size_in_PFStringLifetimeInternmentSingleton_t);
    ADD_TEST(fn_pf_string_lifetime_internment_emplace_cstr__sets_correct_error_message__for_invalid_owned_memory_size_in_PFStringLifetimeInternmentSingleton_t);
    ADD_TEST(fn_pf_string_lifetime_internment_emplace_cstr__returns_correct_error_code__for_used_memory_size_greather_than_owned_memory_size_PFStringLifetimeInternmentSingleton_t);
    ADD_TEST(fn_pf_string_lifetime_internment_emplace_cstr__sets_correct_error_message__for_used_memory_size_greater_than_owned_memory_size_in_PFStringLifetimeInternmentSingleton_t);
    // second param
